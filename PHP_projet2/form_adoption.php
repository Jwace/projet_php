...
<form action="traitement_adoption.php" method="POST" style="text-align:center;">
    ...
    <label for="nom_animal">Nom de l'animal que vous souhaitez :</label>
    <input type="text" name="nom_animal" id="nom_animal"><br><br>
